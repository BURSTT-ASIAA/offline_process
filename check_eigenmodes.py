...
''' % (pg, nPack, p0, blocklen, hdver, fout)
...
#for i in range(36, nFile, 6):   # testing, starting from 7:00am, every 30min
    ...
    tick, spec0 = loadSpec(fh, p0, nPack, bitmap=bitmap, bitwidth=bitwidth, hdver=hdver, verbose=1)
    ...
    savW2.append(W2)
    savV2.append(V2)
    Cov3, norm3 = makeCov(spec, scale=False, coeff=True)
    W3, V3 = Cov2Eig(Cov3)
    savW3.append(W3)
    savV3.append(V3)
